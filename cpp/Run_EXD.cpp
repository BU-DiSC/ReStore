...
// to compile this _IO version, use: g++ -O3 -std=c++2a -pthread -g -o Run_EXD_IO Run_EXD_IO.cpp /home/femu/ReStore_IO/Sibyl_driver/Sibyl_lib.so
...
int main(
    ...
    // use real workload
    std::string workload = "5hf90_1e4_rw1_1e6";
